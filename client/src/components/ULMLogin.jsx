...
const ULMLogin = () => {
  ...
  return (
        ...
        <div className='min-h-screen bg-slate-500 flex items-center justify-center bg-cover bg-center bg-fixed' 
                ...
                <h2 className="text-lg md:text-xl font-semibold text-gray-700 mb-4 flex items-center justify-center">
                    ...
                    <form onSubmit={handleSubmit} className='space-y-4'>
                        ...
                        <input
                            ...
                            required
                            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-blue focus:ring-1 focus:ring-blue-500"
                        />
                        </div>
